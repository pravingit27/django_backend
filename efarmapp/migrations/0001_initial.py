# Generated by Django 3.2 on 2021-04-26 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serving', models.CharField(blank=True, max_length=500, null=True)),
                ('calories', models.CharField(blank=True, max_length=500, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default=True, max_length=500)),
                ('address', models.CharField(default=True, max_length=500)),
                ('phone_num', phone_field.models.PhoneField(blank=True, help_text='contact number', max_length=31)),
                ...
                ('final_total', models.CharField(default=0, max_length=500)),
                ('created_at', models.DateField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now_add=True)),
                ('products', models.ManyToManyField(to='efarmapp.Product')),
            ],
            options={
                'ordering': ['-created_at'],
            },
